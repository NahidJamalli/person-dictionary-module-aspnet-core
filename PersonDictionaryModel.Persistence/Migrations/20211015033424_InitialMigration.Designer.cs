...
namespace PersonDictionaryModel.Persistence.Migrations
{
    ...
    [Migration("20211015033424_InitialMigration")]
            ...
            modelBuilder.Entity("PersonDictionaryModel.Core.Domain.Models.Person", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BirthDate = new DateTime(2000, 10, 15, 7, 34, 23, 853, DateTimeKind.Local).AddTicks(9952),
                            CityId = 1,
                            FirstName = "John",
                            Gender = 0,
                            LastName = "Doe",
                        ...
                        {
                            Id = 2,
                            BirthDate = new DateTime(2006, 10, 15, 7, 34, 23, 854, DateTimeKind.Local).AddTicks(6927),
                            CityId = 2,
                            FirstName = "Ella",
                            Gender = 1,
                            LastName = "Doe",
                        ...
                        {
                            Id = 3,
                            BirthDate = new DateTime(1989, 10, 15, 7, 34, 23, 854, DateTimeKind.Local).AddTicks(6947),
                            CityId = 3,
                            FirstName = "Marta",
                            Gender = 1,
                            LastName = "Bella",
